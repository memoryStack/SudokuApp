...
const ACTION_HANDLERS = {
    ...
    [BOARD_GENERIC_ACTION_TYPES.ON_CELL_PRESS]: handleCellClick,
    [INPUT_PANEL_ACTION_TYPES.ON_ERASE_CLICK]: handleEraserClick,
    [INPUT_PANEL_ACTION_TYPES.ON_NUMBER_CLICK]: handleNumberClick,
}
