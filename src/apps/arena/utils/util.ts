...
import { AUTO_GENERATED_NEW_GAME_IDS, NEW_GAME_IDS } from '@application/usecases/newGameMenu/constants'
...
export const isAutoGeneratedPuzzleType = (puzzleType: NEW_GAME_IDS) => {
    return [
