...
export const analyzeOmissionInHouse = (note: NoteValue, house: House, mainNumbers: MainNumbers, notesData: Notes) => {
...
export const getHouseOmissions = (house: House, mainNumbers: MainNumbers, notesData: Notes): RawOmissionHint[] => {
    const result = []
...
export const getOmissionRawHints = (mainNumbers: MainNumbers, notesData: Notes, maxHintsThreshold: number) => {
