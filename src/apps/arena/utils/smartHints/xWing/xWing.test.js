import { areXWingCells, getAllXWings, getHouseXWingLegs, isFinnedLeg, areFinnedXWingLegs, isFinnedXWingRemovesNotes } from '.'
...
describe('are finned X-Wing cells', () => {
    test('test 1', () => {
        ...
        expect(areFinnedXWingLegs(perfectLegHostCells, otherLegHostCells)).toBe(true)
    })
    ...
    test('test 2', () => {
        ...
        expect(areFinnedXWingLegs(perfectLegHostCells, otherLegHostCells)).toBe(false)
    })
