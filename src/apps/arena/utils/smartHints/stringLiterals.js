...
export const HINT_EXPLANATION_TEXTS = {
    ...
    [HINTS_IDS.Y_WING]: `In the highlighted green cell, either {{firstPivotNote}} or {{secondPivotNote}} can come here. now whatever comes in the green cell, one of the orange cell will be {{commonNoteInWings}} for sure. and the notes highlighted in the red in cells which can be seen by both orange cells can be eliminated.`,
}
